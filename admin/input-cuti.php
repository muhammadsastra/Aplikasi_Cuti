                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="tanggal_masuk" name="tanggal_masuk" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" placeholder="Sampai dengan" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
