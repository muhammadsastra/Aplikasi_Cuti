...
<?php
$kd = $_GET['kd'];
			$sql = mysqli_query($koneksi, "SELECT * FROM departemen WHERE id_dep='$kd'");
			...
			if(isset($_POST['update'])){
				...
				$update = mysqli_query($koneksi, "UPDATE departemen SET departemen='$departemen' WHERE id_dep='$kd'") or die(mysqli_error());
				if($update){
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="id_dep" name="id_dep" value="<?php echo $row['id_dep']; ?>" class="form-control" readonly="readonly">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="departemen" value="<?php echo $row['departemen']; ?>" name="departemen" class="form-control" placeholder="Departemen" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
