...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="INSERT INTO user (user_id,username,password,fullname,level,gambar) VALUES
                        ...
                        <div class="col-sm-5">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Input</strong> Admin
                                </div>
                                <div class="card-body">
                                    <form action="input-admin.php" method="post" enctype="multipart/form-data" name="input" class="form-horizontal">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-key"></i>
                                                    </span>
                                                    <input type="text" id="user_id" name="user_id" class="form-control" value="<?php $a = rand(0000001,2000000); echo $a; ?>" readonly="readonly">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="file" id="nama_file" name="nama_file" class="form-control" placeholder="Username" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
