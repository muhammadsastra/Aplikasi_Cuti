...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
   ...
   <?php include "menu.php"; ?>
        ...
        <main class="main">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <div class="col-lg-12">
              <form action='laporan-cuti-karyawan.php' method="POST">
          ...
          <div class="col-lg-3">
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='laporan-cuti-karyawan.php' class="btn btn-sm btn-success" > Refresh</a>
          </div>
          </div>
           </form>
          	</div>
   ...
   <iframe id="printing-frame" name="print_frame" src="about:blank" style="display:none;"></iframe>
    ...
    <div class="text-right">
                  <a href="cetak-cuti-karyawan.php?kd=<?php echo $_POST['tglawal'];?>&&kode=<?php echo $_POST['tglakhir'];?>&&nama=<?php echo $_POST['nama'];?>" target="_blank" class="btn btn-sm btn-info">Export PDF  <i class="fa fa-download"></i></a>
