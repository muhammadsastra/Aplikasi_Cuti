            ...
            <div class="col-md-5">
                <div class="card-group mb-0">
                    <div class="card p-4">
                        <div class="card-body">
								<marquee>
								<span class="style1">Untuk Informasi mengenai prosedur, dasar hukum dan hal lainnya mengenai Permohonan dan Pemberian Cuti PNS silahkan <a href="http://sicakep.pangkalpinangkota.go.id/infocuti/" target="_blank">[klik disini</a></span><a href="http://sicakep.pangkalpinangkota.go.id/infocuti/">]</a>
								</marquee>
                            <h1 align="center"><img src="img/kinerja.png" width="286" height="162"></h1>
                            <h1 align="center">Login Pegawai Cuti </h1>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="nik" class="form-control" placeholder="NIP anda" autocomplete="off" name="nik" id="nik">
                            </div>
